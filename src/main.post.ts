import { Scene, PerspectiveCamera, WebGL1Renderer, AmbientLight, MeshPhongMaterial, Mesh, BoxGeometry, Vector3, DepthTexture, Vector2 } from 'three';
...
// composer.addPass(new RenderPixelatedPass(3, scene, camera))
// composer.addPass(new UnrealBloomPass(new Vector2(9, 9), 3, 10, 0.2))
