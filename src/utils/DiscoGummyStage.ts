...
export class DiscoGummyStage extends Stage {
  ...
  constructor(
    ...
    const urls = [
        "brown_clouds/browncloud_ft.jpg",
        "brown_clouds/browncloud_bk.jpg",
        "brown_clouds/browncloud_up.jpg",
        "brown_clouds/browncloud_dn.jpg",
        "brown_clouds/browncloud_rt.jpg",
        "brown_clouds/browncloud_lf.jpg",
    ];
